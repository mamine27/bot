...
async function initDB() {
  ...
  try {
    // Initialize Professional Mission Schema
    await client.query(`
    ...
    // Auto-onboard SuperAdmin from ENV
    ...
    console.log('🏛 Postgres Mission Database Initialized.');
  } finally {
    client.release();
  }
}

// Helper methods translated for Postgres
const db = {
